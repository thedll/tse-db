...
public class Main
{
	public static void main(String[] args) 
    {
    	...
    	try {
    		...
    		try {
                    ...
                    System.out.print("Digite o caminho para o diretório dos candidatos: ");
					String candidatesPath = tc.nextLine();
					File f = new File(candidatesPath);
					String [] nomes = f.list();

    				for(String s : nomes) {
						System.out.println(s);
		        		String file = candidatesPath+s;
	...
	public static void banner() {
		...
		System.out.println("|_   _/ ___|| ____|   __| | |__  ");
		System.out.println("  | | \\___ \\|  _|    / _` | '_ \\ ");
		System.out.println("  | |  ___) | |___  | (_| | |_) |");
		System.out.println("  |_| |____/|_____|  \\__,_|_.__/");
	}
